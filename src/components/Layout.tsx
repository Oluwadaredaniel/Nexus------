...
import { LogOut, LayoutDashboard, Users, BookOpen, GraduationCap, BarChart, Building2, UserCog, User, Home } from 'lucide-react';
...
export default function Layout() {
  ...
  const adminLinks = [
    ...
    { icon: Users, label: "People", path: "/admin/class-lists" },
    { icon: UserCog, label: "Reps", path: "/admin/assign-rep" },
  ];

  const repLinks = [
    { icon: LayoutDashboard, label: "Dash", path: "/rep" },
    { icon: Users, label: "Sessions", path: "/rep/sessions" },
  ];

  const studentLinks = [
    { icon: Home, label: "Home", path: "/student" },
    { icon: GraduationCap, label: "History", path: "/student/history" },
