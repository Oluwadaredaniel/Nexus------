...
import { Wifi, Clock, Users, Download, Play, StopCircle, GraduationCap } from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex items-center gap-4">
           <div className="hidden md:flex flex-col items-end mr-4 border-r border-white/10 pr-6">
              <span className="text-xs text-muted-foreground uppercase tracking-widest">My Personal Stats</span>
              <span className="text-sm font-bold flex items-center gap-2 text-white"><GraduationCap className="h-4 w-4 text-primary" /> {myAttendanceCount} Classes Attended</span>
           </div>
